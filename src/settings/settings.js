...
const card_background = "rgba(255,255,255,0.1)"
const node_color = card_background;
const edge_color = important_font;
export {getPageRank,getCommunityDetect,getShortestPath,canvas_background,important_font,plain_text,card_background,node_color,edge_color}