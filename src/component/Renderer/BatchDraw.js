...
export default class BatchDrawer {
    ...
    _initUniforms() {
        ...
        let dotTranslate = this.GL.getUniformLocation(this.dotProgram, 'resolutionTranslate');
        this.GL.uniform2f(dotTranslate, this.transform.x, this.transform.y);
        if (this.coordinateSystem != this.WGS84) {
    ...
    _initShaders() {
        ...
        if (this.GLVersion == 2) {
            ...
            dotVertexSource =    `#version 300 es
                                  ...
                                  void main(void) {
                                    color = dotColor;
                                    vec2 dotPos = resolutionScale * inDotPos + resolutionTranslate;
                                    float dotSize = inDotSize; // * resolutionScale.x;
                                    mat3 translate = mat3(
                                      dotSize, 0, 0,
                                      0, dotSize, 0,
                                      dotPos.x, dotPos.y, 1);
